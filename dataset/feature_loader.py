...
class FusedFeatureLoader(Point3DLoader):
    ...
    def __init__(self,
        ...
        # if split == 'val':
        #     self.datapath_feat = '/data/xuxiaoxu/code/openvocabulary/ovdet_2d/lseg_feature_extraction/scannet_process_val'
    ...
    def __getitem__(self, index_long):
        ...
        # load 3D features
        if self.dataset_name == 'scannet_3d' or self.dataset_name == 'scannet_3d_200':
