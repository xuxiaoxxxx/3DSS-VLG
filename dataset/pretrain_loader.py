...
class FusedFeatureLoader(Point3DLoader):
    ...
    def __init__(self,
        ...
        # add the path change
        if split == 'train':
            self.datapath_feat = '/data/xuxiaoxu/code/openvocabulary/ovdet_2d/pointnet/openseg_pretrain_feat_3d'    # filter by mlp
            # self.datapath_feat = '/data/xuxiaoxu/code/openvocabulary/ovdet_2d/openscene/test_process'         # base process
