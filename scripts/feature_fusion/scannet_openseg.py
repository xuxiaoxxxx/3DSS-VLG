...
def get_args():
    ...
    parser.add_argument('--data_dir', default='/data/xuxiaoxu/code/openvocabulary/ovdet_2d/openscene/data', type=str, help='Where is the base logging directory')
    parser.add_argument('--split', type=str, default='train', help='split: "train"| "val"')
    parser.add_argument('--output_dir', default='/data/xuxiaoxu/code/openvocabulary/ovdet_2d/openscene/test_process', type=str, help='Where is the base logging directory')
    parser.add_argument('--openseg_model', type=str, default='/data/xuxiaoxu/code/openvocabulary/ovdet_2d/openscene/openseg_model_pre_weight/openseg_exported_clip', help='Where is the exported OpenSeg model')
