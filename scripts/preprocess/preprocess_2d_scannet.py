...
parser.add_argument('--scannet_path', default='/data/xuxiaoxu/test/temp_scans', help='path to scannet data')
parser.add_argument('--output_path', default='/data/xuxiaoxu/code/openvocabulary/ovdet_2d/openscene/scannet_process_2d_320x240', help='where to output 2d data')
...
def main():
    ...
    for i in range(begin, end):
        ...
        label_path = os.path.join('/data/xuxiaoxu/test/temp_label-filt', scenes[i], opt.label_type)
