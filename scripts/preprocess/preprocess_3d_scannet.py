...
#####################################
split = 'test' # choose between 'train' | 'val'
out_dir = '../../data/scannet_3d/{}'.format(split)
in_path = '/data/xuxiaoxu/dataset/scannet/scans_test' # downloaded original scannet data
...
p.map(process_test_one_scene, files)
p.close()
p.join()
